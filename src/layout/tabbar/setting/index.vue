<template>
            ...
            <el-button type="primary" size="small" icon="FullScreen" circle @click="fullScreen" style="margin-right: 20px;" ></el-button>
...
//刷新按钮点击回调
// const updateRefsh = () => {
//     layoutSettingStore.refsh = !layoutSettingStore;
// }
...
// const logout = async () => {
//     //1、需要向服务器发请求(退出登录接口)
//     //2、仓库当中关于用户的相关数据清空(token|username|avatar)
//     //3、跳转登录页面
